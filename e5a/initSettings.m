...
% based only. 
skipsec     = .01;
settings.skipNumberOfBytes     = 16*1023;
%% Raw signal file name and other parameter ===============================
% This is a "default" name of the data file (signal record) to be used in
% the post-processing mode

settings.fileName           = 'gpsSig.txt';
...
settings.IF                 = 0;      %[Hz]
settings.samplingFreq       = 2*10.23e6;     %[Hz]
...
% up acquisition
settings.acqSatelliteList   = 1:36;         %[PRN numbers]
...
settings.elevationMask      = -20;           %[degrees 0 - 90]
