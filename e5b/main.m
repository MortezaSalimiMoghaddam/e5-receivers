...
filename = '/home/mori/MatlabFiles/simulator/galileoTest/galileoSimV2/build/50galileo.bin';
% filename = '/home/mori/MatlabFiles/simulator/e5a/galNew.bin';
% filename = '/home/mori/MatlabFiles/simulator/gnss-sdr/gnss-sdr/fre_1207';
n = fs*0.075;
...
for i=1:acqnumber
    ...
    [ epoch, prompt,sa ] = Track_E5b( fid,filename,fs,coffset,prn,doppler ,code_offset);
